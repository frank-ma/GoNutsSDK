...
// * Desc:
// */
//public class LoginDialogCopy extends Dialog {
//
//    public LoginDialogCopy(@NonNull Context context) {
//        super(context);
//    }
//
//    public LoginDialogCopy(@NonNull Context context, int themeResId) {
//        super(context, themeResId);
//    }
//
//    protected LoginDialogCopy(@NonNull Context context, boolean cancelable, @Nullable OnCancelListener cancelListener) {
