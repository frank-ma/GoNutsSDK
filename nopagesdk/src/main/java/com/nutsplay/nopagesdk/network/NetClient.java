...
public class NetClient {
        ...
        x.http().get(params, new Callback.CommonCallback<String>() {
            ...
            public void onError(Throwable ex, boolean isOnCallback) {
                if (ex != null) {
                    ...
                    netCallBack.onFailure("ex=null");
                }
            }

            @Override
            public void onCancelled(CancelledException cex) {
                netCallBack.onFailure("connect cancel");
            }
    ...
    public void clientGetLog(String url, Map<String, String> map, Map<String, String> headerMap, final NetCallBack netCallBack) {
        RequestParams params = new RequestParams(url);
        params.setMaxRetryCount(1);
...
//                params.addBodyParameter("",entry.getValue());
        ...
        x.http().post(params, new Callback.CommonCallback<String>() {
            ...
            @Override
            public void onCancelled(CancelledException cex) {
                netCallBack.onFailure(cex.getMessage());
            }
    ...
    public void clientPostLog(String url, Map<String, String> map, Map<String, String> headerMap, final NetCallBack netCallBack) {
        ...
        LogUtils.e(TAG, "log:" + params.toString());
        x.http().post(params, new Callback.CommonCallback<String>() {
            @Override
            public void onSuccess(String result) {
                netCallBack.onSuccess(result);
