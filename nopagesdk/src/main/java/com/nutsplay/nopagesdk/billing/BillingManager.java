...
/**
 * Created by frank-ma on 2019/6/26 5:01 PM
...
//        } else if (resultCode == BillingResult.newBuilder().) {
...
//                mBillingClient.consumeAsync(purchaseToken, onConsumeListener);
    ...
    public void queryPurchaseHistoryAsync(final PurchaseHistoryResponseListener purchaseHistoryResponseListener){
        Runnable queryPurchaseHistory =new Runnable() {
            @Override
            public void run() {
...
//                        if (i == BillingResponse.OK && list!=null && list.size()>0){
